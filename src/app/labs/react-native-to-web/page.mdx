...
# Bringing a React Native App to the Web
...
I did this over about three months, following [an Expo Router migration](/labs/staged-migration-to-expo-router/). What follows is the shape of the work, not a recipe — every codebase does this a bit differently.
